...
import { FileText, Trash2, Shield, ShieldOff, Sheet, Lock, Share2, File, FileKey, FileKey2, Archive, Loader2 } from 'lucide-react';
        ...
        <>
            ...
            {statsLoading ? <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4">
                {Array.from({ length: 4 }).map((_, i) => (
                    ...
                    >
                        <ShieldOff className="absolute top-4 right-4 h-5 w-5 text-muted-foreground" />
                ...
                <Card className="w-full shadow-sm hover:shadow-md transition-all relative">
                    ...
                    <CardHeader className="space-y-1">
                        ...
                        <CardTitle className="text-lg font-semibold">{stats?.sum?.fileSize}KB</CardTitle>
                    </CardHeader>
                </Card>
            </div>}
